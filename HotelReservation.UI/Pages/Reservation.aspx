...
<body>
    ...
    <div class="main-agile">
        <form action="#" method="post" runat="server">
            <input id="dtpStartDate" readonly="true" name="Text" type="text" value="Giriş Tarihi" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'Arrival date';}" required="" runat="server" />
            <input id="dtpEndDate" readonly="true" name="Text" type="text" value="Çıkış Tarihi" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'Departure date';}" required="" runat="server" /><br />
            <asp:Label ID="Label1" runat="server" Text="Oda tipini seçiniz: " ForeColor="White"></asp:Label>
            <asp:DropDownList ID="drpRoomType" runat="server"></asp:DropDownList><br />
            <asp:Label ID="Label2" runat="server" Text="Rezervasyon tipini seçiniz: " ForeColor="White"></asp:Label>
            <asp:DropDownList ID="drpReservationType" runat="server"></asp:DropDownList><br />
            <asp:Label ID="Label3" runat="server" Text="Kaç kişi kalacaksınız: " ForeColor="White"></asp:Label>
            ...
            <asp:Label ID="lblEmptyRoom" runat="server" Text="" ForeColor="White"></asp:Label><br />
            <br />
            <br />
    ...
    <script>
        $(function () {
            $("#dtpStartDate").datepicker({ minDate: 0 });
            $("#dtpEndDate").datepicker({ minDate: 0 });
        });
    </script>
    <!-- //Calendar -->
