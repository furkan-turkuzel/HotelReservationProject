...
namespace HotelReservation.UI.Pages
{
     public partial class RoomTypeSelection : System.Web.UI.Page
     {
          ...
          protected void Page_Load(object sender, EventArgs e)
          {
               if (!IsPostBack)
               {
                    dtpStartDate.Value = DateTime.Now.ToString("dd/MM/yyyy");
                    dtpEndDate.Value = DateTime.Now.AddDays(1).ToString("dd/MM/yyyy");
                    RoomTypeFill();
                    ReservationTypeFill();
                    PersonCountFill();
               }
          ...
          protected void drpPersonCount_SelectedIndexChanged(object sender, EventArgs e)
          {
               ...
               else
               {
                    ...
                    lblEmptyRoom.ForeColor = Color.White;
               }
          }
          ...
          protected void continue_Click(object sender, EventArgs e)
          {
               ...
               Reservations res = (Reservations)Session["reservation"];
